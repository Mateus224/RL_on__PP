...
Transition_dtype = np.dtype([('timestep', np.int32), ('pcl', np.float32, (3,540)),('pose', np.float32, (7)), ('action', np.int32), ('reward', np.float32), ('nonterminal', np.bool_)])
blank_trans = (0, np.zeros((3,540), dtype=np.float32),np.zeros((7), dtype=np.float32), 0, 0.0, False)
