...
from pcl_policy.pcl_rainbow.discriminator.module import Embedding, EmbeddingV2, OwnPCT, NeighborEmbedding,NeighborEmbeddingHigher, OA, OAQ, SA, OAO
...
class Segmentation(nn.Module):
    def __init__(self, part_num):
        ...
        self.convs1 = nn.Conv1d(1920, 256, 1)
