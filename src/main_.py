...
def parse():
    ...
    parser.add_argument('--id', type=str, default='ownAttention_diff_4x2x1', help='Experiment ID')
    parser.add_argument('--model_path', type=str, default = "results/ownAttention_diff_4x2x1/checkpoint.pth", help='model used during testing / visulization') #testmoreFilters.h5
